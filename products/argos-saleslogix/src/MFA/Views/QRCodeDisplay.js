...
define('crm/MFA/Views/QRCodeDisplay', [
  ...
  const __class = declare('crm.MFA.Views.QRCodeDisplay', [View], {
    ...
    supportedAppsText: resource.supportedAppsText,
    googleAuthenticatorText: resource.googleAuthenticatorText,
    microsoftAuthenticatorText: resource.microsoftAuthenticatorText,
    authyText: resource.authyText,
