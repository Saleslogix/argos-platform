...
define('crm/Application', [
      ...
      './actions/user',
      './PicklistService'
    ], function(string, DefaultMetrics, ErrorManager, environment, SDKApplication, offlineManager, MODEL_TYPES, MODEL_NAMES, BusyIndicator, getResource, MingleUtility, indexReducers, configActions, userActions, PicklistService) {
