...
// eslint-disable-next-line no-unused-vars
  ...
  const __class = declare('crm.ApplicationModule', [ApplicationModule], /** @lends module:crm/ApplicationModule.prototype */{
    ...
    loadViews: function loadViews() {
      ...
      this.registerView(new WorkflowInstancesList({
        id: 'account_workflow_instances_related',
        expose: false,
      }));
      this.registerView(new WorkflowInstancesList({
        id: 'contact_workflow_instances_related',
        expose: false,
      }));
      this.registerView(new WorkflowInstancesList({
        id: 'lead_workflow_instances_related',
        expose: false,
      }));
      this.registerView(new WorkflowInstancesList({
        id: 'opportunity_workflow_instances_related',
        expose: false,
      }));
      this.registerView(new WorkflowInstancesList({
        id: 'ticket_workflow_instances_related',
        expose: false,
      }));
